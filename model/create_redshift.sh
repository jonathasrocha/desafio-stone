...
aws redshift create-cluster --cluster-identifier $cluster_name --node-type dc2.large --db-name $redshift_dbname --master-username $redshift_username --master-user-password $redshift_password 
